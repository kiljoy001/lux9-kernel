 ...
 */
int clr_execute_assembly_wasm_with_entry(void *dll_data, ulong dll_size,
                                         const char *entry_name);

int clr_execute_assembly_wasm(void *dll_data, ulong dll_size) {
  return clr_execute_assembly_wasm_with_entry(dll_data, dll_size, nil);
}
