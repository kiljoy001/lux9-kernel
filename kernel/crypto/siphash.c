 ...
 * Adapted for Lux9 kernel - simplified version for hash table use.
 *
...
get_unaligned_le64(const u8int *p)
{
	return (u64int)p[0] |
	       ((u64int)p[1] << 8) |
	       ((u64int)p[2] << 16) |
...
get_unaligned_le32(const u8int *p)
{
	return (u32int)p[0] |
	       ((u32int)p[1] << 8) |
	       ((u32int)p[2] << 16) |
...
get_unaligned_le16(const u8int *p)
{
 ...
 */
u64int
siphash(const void *data, usize len, const siphash_key_t *key)
{
	const u8int *in = data;
	...
	switch (left) {
	case 7: b |= ((u64int)end[6]) << 48; /* fallthrough */
	case 6: b |= ((u64int)end[5]) << 40; /* fallthrough */
	case 5: b |= ((u64int)end[4]) << 32; /* fallthrough */
	case 4: b |= get_unaligned_le32(end); break;
	case 3: b |= ((u64int)end[2]) << 16; /* fallthrough */
 ...
 */
u64int
siphash_1u64(u64int first, const siphash_key_t *key)
{
	u64int v0 = SIPHASH_CONST_0;
	u64int v1 = SIPHASH_CONST_1;
	u64int v2 = SIPHASH_CONST_2;
 ...
 */
u64int
siphash_2u64(u64int first, u64int second, const siphash_key_t *key)
{
	u64int v0 = SIPHASH_CONST_0;
	u64int v1 = SIPHASH_CONST_1;
	u64int v2 = SIPHASH_CONST_2;
 ...
 */
u32int
hsiphash(const void *data, usize len, const hsiphash_key_t *key)
{
	const u8int *in = data;
	const u8int *end = in + len - (len % sizeof(u64int));
	const u8int left = len & (sizeof(u64int) - 1);
 ...
 */
u32int
hsiphash_1u32(u32int first, const hsiphash_key_t *key)
{
	u64int v0 = HSIPHASH_CONST_0;
	u64int v1 = HSIPHASH_CONST_1;
	u64int v2 = HSIPHASH_CONST_2;
 ...
 */
u32int
hsiphash_2u32(u32int first, u32int second, const hsiphash_key_t *key)
{
	u64int v0 = HSIPHASH_CONST_0;
	u64int v1 = HSIPHASH_CONST_1;
	u64int v2 = HSIPHASH_CONST_2;
