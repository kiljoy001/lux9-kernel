...
#define CPU0GDT                                                                \
  (KZERO + 0x217000ull) /* bootstrap processor GDT (UNUSED - using dynamic     \
                           allocation) */
#define CPU0MACH                                                               \
  (KZERO + 0x218000ull) /* Mach for bootstrap processor (UNUSED - using        \
                           dynamic allocation) */
...
#define KDSEL                                                                  \
  SELECTOR(KDSEG, SELGDT,                                                      \
           0) /* Kernel data segment - must be valid for SS in IRETQ */
