...
/* 9P Operations */
Walkqid* pci_9p_walk(struct FamilyExchangePage* family, Chan* c, Chan* nc, char** name, int nname);
...
long pci_9p_read(struct FamilyExchangePage* family, Chan* c, void* buf, long n, vlong off);
long pci_9p_write(struct FamilyExchangePage* family, Chan* c, void* buf, long n, vlong off);
