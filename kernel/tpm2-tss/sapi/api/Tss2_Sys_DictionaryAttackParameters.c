...
#include "../include/tss2_common.h"     // for UINT32, TSS2_RC, TSS2_SYS_RC_BAD_REFERENCE
...
#include "../include/tss2_tpm2_types.h" // for TPMI_RH_LOCKOUT, TPM2_CC_DictionaryAtta...
