...
#include <string.h> // Provided by tss2_kernel.h // Provided by tss2_kernel.h // for memcpy

#include "../sapi/sysapi_util.h"      // for _TSS2_SYS_CONTEXT_BLOB, syscontext_cast
#include "../include/tss2_common.h"      // for TSS2_RC, TSS2_RC_SUCCESS, TSS2_SYS_RC_...
#include "../include/tss2_sys.h"         // for TSS2_SYS_CONTEXT, Tss2_Sys_GetCommandCode
#include "../include/tss2_tpm2_types.h"  // for TPM2_CC
