...
static uchar font8x16[95][16] = {
    ...
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x61, 0x63, 0x06, 0x0C, 0x18, 0x33, 0x63,
     0x00, 0x00, 0x00, 0x00},
    /* & */
    {0x00, 0x00, 0x1C, 0x36, 0x36, 0x1C, 0x3B, 0x6E, 0x66, 0x66, 0x66, 0x3B,
     0x00, 0x00, 0x00, 0x00},
    /* ' */
    ...
    {0x00, 0x00, 0x0C, 0x18, 0x18, 0x30, 0x30, 0x30, 0x30, 0x18, 0x18, 0x0C,
     0x00, 0x00, 0x00, 0x00},
    /* ) */
    {0x00, 0x00, 0x18, 0x0C, 0x0C, 0x06, 0x06, 0x06, 0x06, 0x0C, 0x0C, 0x18,
     0x00, 0x00, 0x00, 0x00},
    /* * */
    {0x00, 0x00, 0x00, 0x00, 0x42, 0x66, 0x3C, 0xFF, 0x3C, 0x66, 0x42, 0x00,
     0x00, 0x00, 0x00, 0x00},
    /* + */
    ...
    {0x00, 0x00, 0x18, 0x38, 0x58, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x7E,
     0x00, 0x00, 0x00, 0x00},
    /* 2 */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xFF,
     0x00, 0x00, 0x00, 0x00},
    /* 3 */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0x03, 0x03, 0x1E, 0x03, 0x03, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* 4 */
    {0x00, 0x00, 0x06, 0x0E, 0x1E, 0x36, 0x66, 0xC6, 0xFF, 0x06, 0x06, 0x0F,
     0x00, 0x00, 0x00, 0x00},
    /* 5 */
    {0x00, 0x00, 0xFF, 0xC0, 0xC0, 0xC0, 0xFC, 0x06, 0x03, 0x03, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* 6 */
    {0x00, 0x00, 0x1C, 0x30, 0x60, 0xC0, 0xFC, 0xC6, 0xC3, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* 7 */
    {0x00, 0x00, 0xFF, 0x03, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x60, 0x60,
     0x00, 0x00, 0x00, 0x00},
    /* 8 */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0x66, 0x3C, 0x66, 0xC3, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* 9 */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0x67, 0x3F, 0x03, 0x06, 0x0C, 0x38,
     0x00, 0x00, 0x00, 0x00},
    /* : */
    ...
    {0x00, 0x00, 0x00, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x0C, 0x18, 0x30, 0x60,
     0x00, 0x00, 0x00, 0x00},
    /* ? */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0x06, 0x0C, 0x18, 0x18, 0x00, 0x18,
     0x00, 0x00, 0x00, 0x00},
    /* @ */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0xCF, 0xDB, 0xDB, 0xCF, 0xC0, 0x7F,
     0x00, 0x00, 0x00, 0x00},
    /* A */
    {0x00, 0x00, 0x08, 0x1C, 0x36, 0x63, 0x63, 0x63, 0x7F, 0x63, 0x63, 0x63,
     0x00, 0x00, 0x00, 0x00},
    /* B */
    {0x00, 0x00, 0xFC, 0x66, 0x63, 0x66, 0x7C, 0x66, 0x63, 0x63, 0x66, 0xFC,
     0x00, 0x00, 0x00, 0x00},
    /* C */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC0, 0xC0, 0xC0, 0xC0, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* D */
    {0x00, 0x00, 0xFC, 0x66, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x66, 0xFC,
     0x00, 0x00, 0x00, 0x00},
    /* E */
    {0x00, 0x00, 0xFF, 0x60, 0x60, 0x60, 0x7C, 0x60, 0x60, 0x60, 0x60, 0xFF,
     0x00, 0x00, 0x00, 0x00},
    /* F */
    {0x00, 0x00, 0xFF, 0x60, 0x60, 0x60, 0x7C, 0x60, 0x60, 0x60, 0x60, 0xF0,
     0x00, 0x00, 0x00, 0x00},
    /* G */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC0, 0xC0, 0xCF, 0xC3, 0xC3, 0x66, 0x3D,
     0x00, 0x00, 0x00, 0x00},
    /* H */
    {0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* I */
    {0x00, 0x00, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x7E,
     0x00, 0x00, 0x00, 0x00},
    /* J */
    {0x00, 0x00, 0x1F, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0xCC, 0xCC, 0xCC, 0x78,
     0x00, 0x00, 0x00, 0x00},
    /* K */
    {0x00, 0x00, 0xC6, 0xCC, 0xD8, 0xF0, 0xE0, 0xF0, 0xD8, 0xCC, 0xC6, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* L */
    {0x00, 0x00, 0xF0, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0xFF,
     0x00, 0x00, 0x00, 0x00},
    /* M */
    {0x00, 0x00, 0xC3, 0xE7, 0xFF, 0xDB, 0xDB, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* N */
    {0x00, 0x00, 0xC3, 0xE3, 0xF3, 0xDB, 0xCF, 0xC7, 0xC3, 0xC3, 0xC3, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* O */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* P */
    {0x00, 0x00, 0xFC, 0x66, 0x63, 0x63, 0x66, 0x7C, 0x60, 0x60, 0x60, 0xF0,
     0x00, 0x00, 0x00, 0x00},
    /* Q */
    {0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xDB, 0x66, 0x3C,
     0x06, 0x03, 0x00, 0x00},
    /* R */
    {0x00, 0x00, 0xFC, 0x66, 0x63, 0x63, 0x66, 0x7C, 0x6C, 0x66, 0x63, 0xF3,
     0x00, 0x00, 0x00, 0x00},
    /* S */
    {0x00, 0x00, 0x3E, 0x63, 0x60, 0x60, 0x3E, 0x03, 0x03, 0x03, 0x63, 0x3E,
     0x00, 0x00, 0x00, 0x00},
    /* T */
    {0x00, 0x00, 0xFF, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* U */
    {0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* V */
    {0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x66, 0x3C, 0x18, 0x08,
     0x00, 0x00, 0x00, 0x00},
    /* W */
    {0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xC3, 0xDB, 0xDB, 0xDB, 0xFF, 0x66, 0x66,
     0x00, 0x00, 0x00, 0x00},
    /* X */
    ...
    {0x00, 0x00, 0xC3, 0xC3, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* Z */
    {0x00, 0x00, 0xFF, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xC0, 0xC0, 0xFF,
     0x00, 0x00, 0x00, 0x00},
    /* [ */
    ...
    {0x00, 0x18, 0x18, 0x18, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
     0x00, 0x00, 0x00, 0x00},
    /* a */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x03, 0x3F, 0x63, 0x63, 0x67, 0x3D,
     0x00, 0x00, 0x00, 0x00},
    /* b */
    {0x00, 0x00, 0xC0, 0xC0, 0xC0, 0xDC, 0xE6, 0xC3, 0xC3, 0xC3, 0xE6, 0xDC,
     0x00, 0x00, 0x00, 0x00},
    /* c */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x63, 0x60, 0x60, 0x60, 0x63, 0x3E,
     0x00, 0x00, 0x00, 0x00},
    /* d */
    {0x00, 0x00, 0x03, 0x03, 0x03, 0x3B, 0x67, 0xC3, 0xC3, 0xC3, 0x67, 0x3B,
     0x00, 0x00, 0x00, 0x00},
    /* e */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3C, 0x66, 0xC3, 0xFF, 0xC0, 0x63, 0x3E,
     0x00, 0x00, 0x00, 0x00},
    /* f */
    {0x00, 0x00, 0x0E, 0x1B, 0x18, 0x18, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x7E,
     0x00, 0x00, 0x00, 0x00},
    /* g */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3B, 0x67, 0xC3, 0xC3, 0x67, 0x3B, 0x03,
     0x63, 0x3E, 0x00, 0x00},
    /* h */
    {0x00, 0x00, 0xC0, 0xC0, 0xC0, 0xDC, 0xE6, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* i */
    ...
    {0x00, 0x00, 0x0C, 0x0C, 0x00, 0x3C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
     0x6C, 0x38, 0x00, 0x00},
    /* k */
    {0x00, 0x00, 0xC0, 0xC0, 0xC0, 0xC6, 0xCC, 0xD8, 0xF8, 0xCC, 0xC6, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* l */
    {0x00, 0x00, 0x78, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x7E,
     0x00, 0x00, 0x00, 0x00},
    /* m */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xEC, 0xFE, 0xDB, 0xDB, 0xDB, 0xDB, 0xDB,
     0x00, 0x00, 0x00, 0x00},
    /* n */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xDC, 0xE6, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* o */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3C, 0x66, 0xC3, 0xC3, 0xC3, 0x66, 0x3C,
     0x00, 0x00, 0x00, 0x00},
    /* p */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xDC, 0xE6, 0xC3, 0xC3, 0xE6, 0xDC, 0xC0,
     0xC0, 0xF0, 0x00, 0x00},
    /* q */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3B, 0x67, 0xC3, 0xC3, 0x67, 0x3B, 0x03,
     0x03, 0x0F, 0x00, 0x00},
    /* r */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xDC, 0xE6, 0xC0, 0xC0, 0xC0, 0xC0, 0xF0,
     0x00, 0x00, 0x00, 0x00},
    /* s */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x63, 0x60, 0x3E, 0x03, 0x63, 0x3E,
     0x00, 0x00, 0x00, 0x00},
    /* t */
    {0x00, 0x00, 0x00, 0x18, 0x18, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x1B, 0x0E,
     0x00, 0x00, 0x00, 0x00},
    /* u */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x67, 0x3B,
     0x00, 0x00, 0x00, 0x00},
    /* v */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0xC3, 0x66, 0x66, 0x3C, 0x3C, 0x18,
     0x00, 0x00, 0x00, 0x00},
    /* w */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0xC3, 0xDB, 0xDB, 0xDB, 0xFF, 0x66,
     0x00, 0x00, 0x00, 0x00},
    /* x */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0xC3,
     0x00, 0x00, 0x00, 0x00},
    /* y */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0xC3, 0x66, 0x3C, 0x18, 0x18, 0x30,
     0x60, 0xE0, 0x00, 0x00},
    /* z */
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x7F,
     0x00, 0x00, 0x00, 0x00},
    /* { */
...
void save_framebuffer_info(void) {
  ...
  /* Limine may give us a virtual address in its HHDM space - convert to
   * physical */
...
void fbconsoleinit(void) {
  ...
  print("fbconsole: about to call vmap(0x%llx, %lld)\n", (uvlong)fbaddr,
        (vlong)size);
  fb.addr = vmap(fbaddr, size);
  print("fbconsole: vmap returned %p\n", fb.addr);
  if (fb.addr == nil) {
  ...
  /* Clear screen - this is slow because it writes to MMIO */
  print("fbconsole: memset %p, size=%lld\n", fb.addr,
        (vlong)(fb.pitch * fb.height));
...
static void fbscroll(void) {
  ...
  src_y = FONT_HEIGHT;
  dst_y = 0;
  memmove(fb.addr + dst_y * fb.pitch, fb.addr + src_y * fb.pitch,
          fb.pitch * (fb.height - FONT_HEIGHT));

  /* Clear bottom line */
  memset(fb.addr + (fb.height - FONT_HEIGHT) * fb.pitch, 0,
