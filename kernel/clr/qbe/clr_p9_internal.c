...
/*
 * P9Internal.Read(uint fid, byte[] buffer, int offset, int count, long position)
 *
 * Sends Tread to the given fid.
 * Returns number of bytes read.
 */
int clr_p9_read(unsigned int fid, void *buffer, int offset, int count, long long position)
{
    Fcall t, r;
    char *data_ptr;
...
/*
 * P9Internal.Write(uint fid, byte[] buffer, int offset, int count, long position)
 *
 * Sends Twrite to the given fid.
 * Returns number of bytes written.
 */
int clr_p9_write(unsigned int fid, void *buffer, int offset, int count, long long position)
{
    Fcall t, r;
    char *data_ptr;
