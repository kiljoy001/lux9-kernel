...
void loadopt(Fn *fn) {
...
#ifdef _KERNEL_QBE
  {
    ...
    char debug_buf[128];
    snprint(debug_buf, sizeof(debug_buf), "DEBUG: loadopt ilog=%p\n", ilog);
...
#ifdef _KERNEL_QBE
  {
    extern void uartputs(char *, int);
    char debug_buf[128];
    snprint(debug_buf, sizeof(debug_buf), "DEBUG: loadopt qsort nlog=%u\n",
            nlog);
    uartputs(debug_buf, strlen(debug_buf));
  }
#endif
...
#ifdef _KERNEL_QBE
  {
    extern void uartputs(char *, int);
    char debug_buf[128];
    snprint(debug_buf, sizeof(debug_buf), "DEBUG: loadopt loop start ib=%p\n",
            ib);
    uartputs(debug_buf, strlen(debug_buf));
  }
#endif
