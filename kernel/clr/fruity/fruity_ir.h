...
void fruity_instruction_set_operand_i32(fruity_instruction_t *instr, s32int val);
void fruity_instruction_set_operand_i64(fruity_instruction_t *instr, s64int val);
void fruity_instruction_set_operand_local(fruity_instruction_t *instr, u32int idx);
...
/* Iterator callbacks */
typedef int (*fruity_instruction_visitor_t)(fruity_instruction_t *instr, void *ctx);
typedef int (*fruity_basic_block_visitor_t)(fruity_basic_block_t *block, void *ctx);
...
void fruity_function_foreach_block(fruity_function_t *func,
                                   ...
                                   void *ctx);
void fruity_basic_block_foreach_instruction(fruity_basic_block_t *block,
