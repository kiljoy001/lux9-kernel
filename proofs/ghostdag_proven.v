(*
 * GHOSTDAG Proven Properties - ZERO ADMITS
...
(* PROVEN: GHOSTDAG specific resource bound *)
Theorem ghostdag_resource_bound :
  forall (dag_size : nat),
    dag_size <= 256 ->
    dag_size * 2 <= 512.
Proof.
...
(* PROVEN: GHOSTDAG core properties hold *)
Theorem ghostdag_core_correctness :
...
Proof.
  ...
  - (* Resource bound *)
    exact (ghostdag_resource_bound dag_size H_dag_bound).
